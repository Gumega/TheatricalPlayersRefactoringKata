...
public class StatementPrinterTests
{
	...
	public async Task TestStatementExampleLegacy()
	{
		...
		var result = StatementPrinter.GenerateStatement(invoice, plays, new TextStatementFormatter());
	...
	public async Task TestXmlStatementExample()
	{
		...
		var result = StatementPrinter.GenerateStatement(invoice, plays, new XMLStatementFormatter());
